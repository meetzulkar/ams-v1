...
export default function CompanyBrand({href='/'}:{href?:string}){
 const [company,setCompany]=useState<{companyName:string;logoUrl:string|null}>({companyName:'Attendance Pro',logoUrl:null});const [failed,setFailed]=useState(false);
